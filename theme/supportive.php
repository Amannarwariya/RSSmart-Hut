                ...
                <div class="row">
                    <div class="col-lg-3 col-sm-6">
                        <div class="card gradient-1">
                            <div class="card-body">
                                <h3 class="card-title text-white">SMART SWITCH</h3>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card gradient-7">
                            <div class="card-body">
                                <h3 class="card-title text-white">SMART BULB</h3>
                                <div class="d-inline-block">
                                    <!-- <h2 class="text-white">75</h2> -->
                                    <p class="text-white mb-0">Failed to Connect </p>
                                </div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card gradient-8">
                            <div class="card-body">
                                <h3 class="card-title text-white">ENERGY ESTIMATE </h3>
                                <div class="d-inline-block">
                                    <!-- <h2 class="text-white">75</h2> -->
                                    <p class="text-white mb-0">Failed to Connect </p>
                                </div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card gradient-3">
                            <div class="card-body">
                                <h3 class="card-title text-white">SPEAKER </h3>
                                <div class="d-inline-block">
                ...
                <div class="row">
                    <div class="col-lg-3 col-sm-6">
                        <div class="card gradient-4">
                            <div class="card-body">
                                <h3 class="card-title text-white">LIGHT SENSOR</h3>
                                <div class="d-inline-block">
                                    <!-- <h2 class="text-white">75</h2> -->
                                    <p class="text-white mb-0">Failed to Connect</p>
                                </div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card gradient-9">
                            <div class="card-body">
                                <h3 class="card-title text-white">SMART FAN </h3>
                                <div class="d-inline-block">
                                    <!-- <h2 class="text-white">75</h2> -->
                                    <p class="text-white mb-0">Failed to Connect</p>
                                </div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card gradient-6">
                            <a href="cctv-camera.php">
                                <div class="card-body">
                                    <h3 class="card-title text-white">CAMERA </h3>
                                    <div class="d-inline-block">
                                        <!-- <h2 class="text-white">75</h2> -->
                                        <p class="text-white mb-0">Failed to Connect</p>
                                    </div>
