    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="content-body mt-5">
            ...
            <h4 class="card-title" style="margin-left: 2vw;">All Appliances</h4>
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title" style="font-size:1vw ; margin-bottom: 2vw;">BED ROOM DEVICES</h4>
                    ...
                    <div class="card-body">
                        <h4 class="card-title" style="font-size:1vw ; margin-bottom: 2vw;">DINING ROOM DEVICES</h4>
                        <div class="table-responsive">
                            <table class="table header-border">
                                <thead>
                                    <tr>
                    ...
                    <div class="card-body">
                        <h4 class="card-title" style="font-size:1vw ; margin-bottom: 2vw;">GUEST ROOM DEVICES</h4>
                        <div class="table-responsive">
                            <table class="table header-border">
                                <thead>
                                    <tr>
                    ...
                    <div class="card-body">
                        <h4 class="card-title" style="font-size:1vw ; margin-bottom: 2vw;">LIVING ROOM DEVICES</h4>
                        <div class="table-responsive">
                            <table class="table header-border">
                                <thead>
                                    <tr>
                    ...
                    <div class="card-body">
                        <h4 class="card-title" style="font-size:1vw ; margin-bottom: 2vw;">STORE ROOM DEVICES</h4>
                        <div class="table-responsive">
                            <table class="table header-border">
                                <thead>
                                    <tr>
                    ...
                    <div class="card-body">
                        <h4 class="card-title" style="font-size:1vw ; margin-bottom: 2vw;">STUDY ROOM DEVICES</h4>
                        <div class="table-responsive">
                            <table class="table header-border">
                                <thead>
                                    <tr>
                    ...
                    <div class="card-body">
                        <h4 class="card-title" style="font-size:1vw ; margin-bottom: 2vw;">HALL DEVICES</h4>
                        <div class="table-responsive">
                            <table class="table header-border">
                                <thead>
                                    <tr>
