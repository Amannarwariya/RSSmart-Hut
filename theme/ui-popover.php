            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Custom Tooltip php</h4>
                                <button type="button" class="btn btn-secondary" data-toggle="tooltip" data-php="true" title="<em>Tooltip</em> <u>with</u> <b>php</b>">Tooltip with php</button>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-12">
