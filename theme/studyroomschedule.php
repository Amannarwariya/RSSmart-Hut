...
<head>
  ...
  <link rel="stylesheet" href="css/timestatus.css">
...
<body>
        ...
        <div class="nk-sidebar" style="position: fixed; max-height: fit-content; overflow: scroll;">
          <div class="nk-nav-scroll">
              <ul class="metismenu" id="menu" style="background-color: whitesmoke; border: 2px solid white;">
                  ...
                  <li>
                     <a href="./cctv-camera.php" aria-expanded="false">
                        <i class="ri-camera-fill"></i> <span class="nav-text">CCTV Camera</span>
                     </a>
                  </li>
                  <li>
                      <a href="./setting.php">
      ...
      <div class="container-fluid mt-3">
        <div class="row">
          <div class="col-lg-3 col-sm-6">
            <div class="card gradient-1 nft3">
              <a href="">
              <div class="card-body">
                  <h3 class="card-title text-white">TOTAL DEVICES</h3>
                  <div class="d-inline-block">
                    <h2 class="text-white">5</h2>
                    <p class="text-white mb-0">Is Connected in <br> Study Room</p>
                  </div>
          ...
          <div class="col-lg-3 col-sm-6">
            <div class="card gradient-2 nft2">
              <a href="">
              <div class="card-body">
          ...
          <div class="col-lg-3 col-sm-6">
            <div class="card gradient-3 nft4">
              <a href="">
              <div class="card-body">
          ...
          <div class="col-lg-3 col-sm-6">
            <div class="card gradient-4 nft6">
              <a href="./inhome.php">
              <div class="card-body">
          ...
          <div class="card-body">
            <h4 class="card-title" style="font-size:1vw ; margin-bottom: 2vw;">STUDY ROOM </h4>
            <div class="table-responsive">
              <table class="table header-border">
                ...
                <tbody>
                  <tr>
                    <th style="align-content: center;">1</th>
                    <td>Light 1</td>
                    <td><span id="status1" class="status-light status-off"></span></td>
                    <td>
                      <div class="form-group "
                        style="display:flex; justify-content: space-between; width: 60%; align-items: center;">
                        <span>
                          <input type="time" id="start1" onclick="startTimers()" class="form-control" value="07:00"></span>
                        <span>
                          <input type="time" id="end1" class="form-control" value="07:15">
                        </span>
                      </div>
                    </td>                  
                  </tr>
                  <tr>
                    <th style="align-content: center;">2</th>
                    <td>Lamp</td>
                    <td><span id="status2" class="status-light status-off"></span></td>
                    <td>
                      <div class="form-group "
                        style="display:flex; justify-content: space-between; width: 60%; align-items: center;">
                        <span>
                          <input type="time" id="start2" onclick="startTimers()" class="form-control" value="07:30">
                        </span>
                        <span>
                          <input type="time" id="end2" class="form-control" value="07:45">
                        </span>
                      </div>
                    </td>
                  </tr>
                  <tr>
                    <th style="align-content: center;">3</th>
                    <td>Switch</td>
                    <td><span id="status3" class="status-light status-off"></span></td>
                    <td>
                      <div class="form-group "
                        style="display:flex; justify-content: space-between; width: 60%; align-items: center;">
                        <span>
                          <input type="time" id="start3" onclick="startTimers()" class="form-control" value="08:00"></span>
                        <span>
                          <input type="time" id="end3" class="form-control" value="08:15">
                        </span>
                      </div>
                    </td>
                  </tr>
                  <tr>
                    <th style="align-content: center;">4</th>
                    <td>Fan</td>
                    <td><span id="status4" class="status-light status-off"></span></td>
                    <td>
                      <div class="form-group "
                        style="display:flex; justify-content: space-between; width: 60%; align-items: center;">
                        <span>
                          <input type="time" id="start4" onclick="startTimers()" class="form-control" value="08:30"></span>
                        <span>
                          <input type="time" id="end4" class="form-control" value="08:45">
                        </span>
                      </div>
                    </td>
                  </tr>
                  <tr>
                    <th style="align-content: center;">5</th>
                    <td>Ac</td>
                    <td><span id="status5" class="status-light status-off"></span></td>
                    <td>
                      <div class="form-group "
                        style="display:flex; justify-content: space-between; width: 60%; align-items: center;">
                        <span>
                          <input type="time" id="start5" onclick="startTimers()" class="form-control" value="09:00"></span>
                        <span>
                          <input type="time" id="end5" class="form-control" value="09:15">
                        </span>
                      </div>
                    </td>
                  </tr>
  ...
  <script src="./js/studyroomtimestatus.js"></script>
