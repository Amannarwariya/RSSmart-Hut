                ...
                <div class="row">
                    <div class="col-lg-3 col-sm-6">
                        <div class="card gradient-1">
                            <a href="bedroomschedule.php">
                                <div class="card-body">
                                    <h3 class="card-title text-white">SCHEDULE</h3>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card gradient-3">
                            <a href="dineroomschedule.php">
                                <div class="card-body">
                                    <h3 class="card-title text-white">SCHEDULE</h3>
                                    <div class="d-inline-block">
                                        <h2 class="text-white">5</h2>
                                        <p class="text-white mb-0">Connected in <br> Dining Room</p>
                                    </div>
                                    <span class="float-right display-5 opacity-5"><i
