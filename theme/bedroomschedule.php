...
<body>
    ...
    <div class="content-body">
      ...
      <div class="container-fluid mt-3">
        <div class="row">
              ...
              <a href="">
                <div class="card-body">
                  ...
                  <div class="d-inline-block">
                    ...
                    <p class="text-white mb-0">Is Connected in <br> Bed Room</p>
                  </div>
          ...
          <div class="col-lg-3 col-sm-6">
            <div class="card gradient-2 nft6">
              <a href="">
                <div class="card-body">
          ...
          <div class="col-lg-3 col-sm-6">
            <div class="card gradient-4 nft5">
              <a href="./inhome.php">
                <div class="card-body">
          ...
          <div class="card-body">
            <h4 class="card-title" style="font-size:1vw ; margin-bottom: 2vw;">BED ROOM </h4>
              ...
              <table class="table header-border">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <div class="form-group "
                        ...
                        <span>
                          <input type="time" id="start1" onclick="startTimers()" class="form-control"
                            value="07:00"></span>
                        <span>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="form-group "
                        style="display:flex; justify-content: space-between; width: 60%; align-items: center;">
                        <span>
                          <input type="time" id="start3" onclick="startTimers()" class="form-control"
                            value="08:00"></span>
                        <span>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="form-group "
                        style="display:flex; justify-content: space-between; width: 60%; align-items: center;">
                        <span>
                          <input type="time" id="start4" onclick="startTimers()" class="form-control"
                            value="08:30"></span>
                        <span>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="form-group "
                        style="display:flex; justify-content: space-between; width: 60%; align-items: center;">
                        <span>
                          <input type="time" id="start5" onclick="startTimers()" class="form-control"
                            value="09:00"></span>
                        <span>
                  ...
                  <!-- <tr>
                    <th></th>
                    <td></td>
                    <td><button class="btn btn-primary" onclick="startTimers()">Start All Timers</button></td>
                    <td></td>
                  </tr> -->
                </tbody>
              </table>
 ...
 <footer class="footer ">
  ...
  <!-- status and timer script -->
  <script src="js/bedroomtimestatus.js"></script>
