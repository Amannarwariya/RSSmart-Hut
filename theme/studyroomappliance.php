              ...
              <table class="table header-border">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <label class="switch">
                        <input type="checkbox" id="deviceSwitch1" onchange="toggleStatus(1)">
                  ...
                  <tr>
                    ...
                    <td>
                      <label class="switch">
                        <input type="checkbox" id="deviceSwitch2" onchange="toggleStatus(2)">
                        <span class="slider"></span>
                      </label>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td>Switch</td>
                    <td>
                      <div class="status-indicator" id="statusIndicator3"></div>
                    </td>
                    <td>
                      <label class="switch">
                        <input type="checkbox" id="deviceSwitch3" onchange="toggleStatus(3)">
                        <span class="slider"></span>
                      </label>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td>Fan</td>
                    <td>
                      <div class="status-indicator" id="statusIndicator4"></div>
                    </td>
                    <td>
                      <label class="switch">
                        <input type="checkbox" id="deviceSwitch4" onchange="toggleStatus(4)">
                        <span class="slider"></span>
                      </label>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td>AC</td>
                    <td>
                      <div class="status-indicator" id="statusIndicator5"></div>
                    </td>
                    <td>
                      <label class="switch">
                        <input type="checkbox" id="deviceSwitch5" onchange="toggleStatus(5)">
                        <span class="slider"></span>
                      </label>
                    </td>
                  </tr>
