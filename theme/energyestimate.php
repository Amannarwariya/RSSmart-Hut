                ...
                <div class="row">
                    <div class="col-lg-3 col-sm-6">
                        <div class="card gradient-1">
                            <a href="./energy-estimate-home.php">
                                <div class="card-body">
                                    <h3 class="card-title text-white">HOME</h3>
                                    <div class="d-inline-block">
                                        <!-- <h2 class="text-white">75</h2> -->
                                        <p class="text-white mb-0">Failed To Fetch Energy </p>
                                    </div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card gradient-2">
                            <a href="./energy-estimate-kitchen.php">
                                <div class="card-body">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card gradient-3">
                            <a href="./energy-estimate-dining-room.php">
                            <div class="card-body">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card gradient-4">
                            <a href="./energy-estimate-study-room.php">
                            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-lg-3 col-sm-6">
                        <div class="card gradient-5">
                            <a href="./energy-estimate-hall.php">
                            <div class="card-body">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card gradient-6">
                            <a href="./energy-estimate-guest-room.php">
                            <div class="card-body">
