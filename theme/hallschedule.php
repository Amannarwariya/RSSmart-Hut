...
<body>
    ...
    <div class="content-body">
      ...
      <div class="container-fluid mt-3">
        <div class="row">
            ...
            <div class="card gradient-1 nft6">
              ...
              <div class="card-body">
                  ...
                  <div class="d-inline-block">
                    ...
                    <p class="text-white mb-0">Is Connected in <br> Hall</p>
                  </div>
          ...
          <div class="col-lg-3 col-sm-6">
            <div class="card gradient-4 nft4">
              <a href="./inhome.php">
              <div class="card-body">
          ...
          <div class="card-body">
            <h4 class="card-title" style="font-size:1vw ; margin-bottom: 2vw;">HALL</h4>
  ...
  <script src="js/halltimer.js"></script>
