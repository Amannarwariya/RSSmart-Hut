            ...
            <div class="nk-nav-scroll" style="overflow: scroll">
                <ul class="metismenu" id="menu" style="background-color: whitesmoke; border: 2px solid white;">
                    <li class="mega-menu mega-menu-sm">
                        <a href="">
                            <lord-icon src="https://cdn.lordicon.com/xfyxpoer.json" trigger="loop" delay="500" style="width:15px;height:15px">
                            </lord-icon> <span class="nav-text ml-2"> Dashboard </span>
                        </a>
                    </li>
                    <li class="mega-menu mega-menu-sm">
                        <a href="./allroom.php">
                            <lord-icon src="https://cdn.lordicon.com/wmwqvixz.json" trigger="loop" delay="500" style="width:15px;height:15px">
                            </lord-icon> <span class="nav-text ml-2"> Rooms</span>
                        </a>
                    </li>
                    <li>
                        <a href="./connected.php" aria-expanded="false">
                            <lord-icon src="https://cdn.lordicon.com/dkhzauae.json" trigger="loop" delay="500" style="width:15px;height:15px">
                            </lord-icon> <span class="nav-text ml-2">Connected Devices</span>
                        </a>
                    </li>
                    <li>
                        <a href="./schedule.php">
                            <lord-icon src="https://cdn.lordicon.com/wmlleaaf.json" trigger="loop" delay="500" style="width:15px;height:15px">
                            </lord-icon> <span class="nav-text ml-2">Schedule</span>
                        </a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="./energyestimate.php" aria-expanded="false">
                            <lord-icon src="https://cdn.lordicon.com/sbrtyqxj.json" trigger="loop" delay="500" style="width:15px;height:15px">
                            </lord-icon> <span class="nav-text ml-2">Energy Estimate</span>
                        </a>
                    </li>
                    <li>
                    ...
                    <li >
                        <a href="./setting.php">
                            <lord-icon src="https://cdn.lordicon.com/ifsxxxte.json" trigger="loop" delay="500" style="width:15px;height:15px">
                            </lord-icon><span class="nav-text ml-2">Setting</span>
                        </a>
                    </li>
                    <li>
                        <a href="app-profile.php">
                             <lord-icon src="https://cdn.lordicon.com/hrjifpbq.json" trigger="loop" delay="500" style="width:15px;height:15px">
                            </lord-icon><span class="nav-text ml-2">Profile</span>
                            <script src="https://cdn.lordicon.com/lordicon.js"></script>
                            <!-- <lord-icon src="https://cdn.lordicon.com/hrjifpbq.json" trigger="hover" style="width:20px;height:20px">
                            </lord-icon> -->
                        </a>
                    </li>
                    <li>
            ...
            <div class="container-fluid mt-3 ">
                <div class="row">
                    <div class="col-lg-3 col-sm-6 ">
                        <div class="card gradient-1 nft" style="margin-top: 0px;">
                            <div class="card-body ">
                                <a href="./totaldevices.php ">
                                    <h3 class="card-title text-white ">TOTAL DEVICES</h3>
                                    <div class="d-inline-block">
                                        <h2 class="text-white">40</h2>
                                        <p class="text-white mb-0">Is Connected in <br> Home</p>
                                    </div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card gradient-2 nft1 " style="margin-top: 0px;">
                            <div class="card-body">
                                <a href="./ondevices.php">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card gradient-3 nft2" style="margin-top: 0px;">
                            <div class="card-body">
                                <a href="./offdevices.php">
                                    <h3 class="card-title text-white">OFF DEVICES</h3>
                                    <div class="d-inline-block">
                                        <h2 class="text-white">20</h2>
                                        <p class="text-white mb-0">Is Connected In <br> Dine Room</p>
                                    </div>
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card gradient-4 nft3" style="margin-top: 0px;">
                            <div class="card-body">
                                <a href="./inhome.php">
                ...
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">History of Appliances</h4>
                ...
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">History of Sensors</h4>
                        <div class="table-responsive">
                            <table class="table header-border">
                                <thead>
                                    <tr>
                                        <th scope="col">S.NO</th>
                                        <th scope="col">SENSORS NAME</th>
