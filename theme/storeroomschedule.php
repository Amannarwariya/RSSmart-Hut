      ...
      <div class="container-fluid mt-3">
        <div class="row">
          <div class="col-lg-3 col-sm-6">
            <div class="card gradient-1 nft4">
              <a href="">
                <div class="card-body">
                  <h3 class="card-title text-white">TOTAL DEVICES</h3>
                  <div class="d-inline-block">
                    <h2 class="text-white">5</h2>
                    <p class="text-white mb-0">Is Connected in <br> Store Room</p>
                  </div>
          ...
          <div class="card-body">
            <h4 class="card-title" style="font-size:1vw ; margin-bottom: 2vw;">STORE ROOM </h4>
