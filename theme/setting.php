...
<body>
  ...
  <div id="main-wrapper">
    ...
    <div class="content-body">
      <h1 style="text-align: center; margin-top: 5vw;">SETTINGS</h1>
      <div style="display: flex; align-items: center; justify-content: space-between; gap: 10vw; margin: 5vw;">
        <p style="font-size: 2vw; color: black;">BRIGHTNESS</p>
        <input type="range">
      </div>
      <div style="display: flex; align-items: center; justify-content: space-between; gap: 10vw; margin: 5vw;">
        <p style="font-size: 2vw; color: black;">VOLUME</p>
        <input type="range">
      </div>
    </div>
